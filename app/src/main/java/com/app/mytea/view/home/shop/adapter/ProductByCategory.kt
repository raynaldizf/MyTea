...
class ProductByCategory(var shopItems: List<ProductXX>) : RecyclerView.Adapter<ProductByCategory.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.idCard.setOnClickListener{
            ...
            Navigation.findNavController(it)
                .navigate(R.id.action_shopFragment_to_shopDetailFragment, bundle)
        }
    }
}