...
class FertilizerPagerAdapter(fragmentManager: FragmentManager, lifecycle: Lifecycle, private var bundle : Bundle) : FragmentStateAdapter(fragmentManager,lifecycle) {
