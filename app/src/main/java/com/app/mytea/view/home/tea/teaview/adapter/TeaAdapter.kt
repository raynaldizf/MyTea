...
class TeaAdapter(private val itemList: List<DataXXXXXXXXX>) : RecyclerView.Adapter<TeaAdapter.ViewHolder>() {
...
//            .into(holder.binding.ivProductImage)
        ...
        holder.binding.cardViewPest.setOnClickListener{
            ...
            Navigation.findNavController(it).navigate(com.app.mytea.R.id.action_teaViewFragment_to_detailTeaFragment, bundle)
        }
    }
}